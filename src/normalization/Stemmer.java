...
public class Stemmer
	{
		 ...
		 * arbitrary presence, <c><v> gives 0 <c>vc<v> gives 1 <c>vcvc<v> gives
		 * 2 <c>vcvcvc<v> gives 3 ....
		 */
		private final int m()
			{
				int n = 0;
		 ...
		 * trying to restore an e at the end of a short word. e.g. cav(e),
		 ...
		 * agreed -> agree disabled -> disable matting -> mat mating -> mate
		 * meeting -> meet milling -> mill messing -> mess meetings -> meet
		 */
